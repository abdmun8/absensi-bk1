<?php
//digunakan untuk apply loker, harus login terlebih dahulu, jika belum jadi member harus registrasi dlu ya
//defined data loker $loker
if ($loker) {
	?>
	<section>
		<div class="container wow fadeInUp">
			<div class="row">
				<div class="col-md-12">
					<h3 class="section-title"><?php echo $loker->title;?></h3>
		...
		<div class="container about-container wow fadeInUp">
			<div class="row">
				<div class="col-lg-6 about-img">
					<img src="<?php echo base_url('asset/publik/');?>img/about-img.jpg" alt="">
				</div>
