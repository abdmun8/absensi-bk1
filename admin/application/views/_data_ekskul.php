...
if ($param != null) {
    $data = $this->model->getRecord(array(
        'table' => 'ekskul', 'where' => array('id' => $param)
    ));
}
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="data-form-tab">
                                    <form id="data-form">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <label>Nama Eskkul</label>
                                                    <input type="text" id="nama_ekskul" name="nama_ekskul" class="form-control" placeholder="Nama Ekskul">
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group">
                                        ...
                                        <input type="hidden" id="model-input" name="model-input" value="ekskul">
                                    </form>
...
<script>
    ...
    function utilUser() {
        $("#data-table .editBtn").on("click", function() {
            loadContent(base_url + 'view/_data_ekskul/' + $(this).attr('href').substring(1));
        });
    ...
    function getData(idx) {
        $.ajax({
            url: base_url + 'object',
            data: 'model-input=ekskul&key-input=id&value-input=' + idx,
            dataType: 'json',
            type: 'POST',
            cache: false,
            success: function(json) {
                if (json.data.code === 0) {
                    ...
                    $("#nama_ekskul").val(json.data.object.nama_ekskul);
        ...
        swal({
            ...
            function() {
                ...
                setTimeout(function() {
                    $.ajax({
                        url: base_url + 'manage',
                        data: 'model-input=ekskul&action-input=3&key-input=id&value-input=' + n,
                        dataType: 'json',
                        type: 'POST',
                        cache: false,
                        success: function(json) {
    ...
    function refreshTable() {
        tableUser.ajax.url(base_url + '/objects/ekskul').load();
    }
</script>