  <?php
    ...
    if ($param != null) {
        $data = $this->model->getRecord(array(
            'table' => 'tipe_libur', 'where' => array('id' => $param)
        ));
    }
              ...
              <div class="row mb-2">
                  ...
                  <div class="col-sm-6">
                      <ol class="breadcrumb float-sm-right">
                          ...
                          <li class="breadcrumb-item active">Data Hari Libur</li>
                      </ol>
                  </div>
              </div>
          </div><!-- /.container-fluid -->
                              ...
                              <div class="tab-content">
                                  ...
                                  <div class="tab-pane" id="form-tab">
                                      <form id="data-form">
                                          ...
                                          <input type="hidden" id="model-input" name="model-input" value="tipe_libur">
                                      </form>
                                      <div class="row">
  ...
  <script>
      ...
      function getAll() {
          if ($.fn.dataTable.isDataTable('#data-table')) {
              ...
              tableUser = $('#data-table').DataTable({
                  "ajax": base_url + 'objects/tipe_libur',
                  "columns": [{
                          "data": "no"
                      },
                      {
      ...
      function utilUser() {
          ...
          $("#data-table .editBtn").on("click", function() {
              loadContent(base_url + 'view/_data_tipe_libur/' + $(this).attr('href').substring(1));
          });
          ...
          $.ajax({
              ...
              success: function(json) {
                  if (json.data.code === 0) {
                      ...
                      $("#nama_libur").val(json.data.object.nama_libur);
      ...
      function refreshTable() {
          tableUser.ajax.url(base_url + '/objects/tipe_libur').load();
      }
  </script>